...
/**
* PLACEHOLDER TOTAL ENQUANTO NÃO HOUVE CONEXÃO ENTRE FRONTEND E BACKEND
**/

public class PlaceholderAppController {

    private final AccountService accountService;
    private final AuditService auditService;
    private final FileCryptoService fileCryptoService;

    public PlaceholderAppController() {
        this(new AccountService(), new AuditService());
    }
    
    public PlaceholderAppController(AccountService accountService, AuditService auditService) {
        this(accountService, auditService, new FileCryptoService(auditService));
    }

    public PlaceholderAppController(AccountService accountService, AuditService auditService, FileCryptoService fileCryptoService) {
